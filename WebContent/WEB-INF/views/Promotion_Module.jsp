...
<!--                             <span class='icon'><img src="./images/user-icon.png" style="height: 40px;width: 60px; "> secondtruth</span>  <b class="caret"></b> -->
					 <span class="iconlogout">secondtruth</span>  <b class="caret"></b>
                        </a>
		...
		<div id="page-wrapper" style="width: 1090px">
			<div class="container-fluid">
				<div class="row">
					<%-- <div class="col-lg-12">
						<h2 class="page-header" style="padding-left: 320px;">Student Promotion Module ${courseName} ${branchName} ${academicYear}</h2>
					</div> --%>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">Promote All Students to Next 
								year
							...
							<div class="panel-body">
								<div class="row" style="margin-right: 101px;">
									...
									<div class="col-lg-4 ">
										...
										<form action="student_promoted_students_view" method="GET">
            ...
            <label class="control-label" for="selectError">Select Academic Year </label>
									...
									<c:if test="${not empty promoted_list}">
										<table
