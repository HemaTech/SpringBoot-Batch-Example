...
<script type="text/javascript">
	/* function submitFee(){
	 ...
	 alert("Given Date is not Less than From Date");
	 return false;
	 }
	...
	$(document).ready(
			function() {
				...
				$.get('feetypes', function(jsonResponse) {
					...
					$('<option>').val('').text('Choose Fee Type').appendTo(
							fee_type);

					$.each(jsonResponse, function(index, value) {
						$('<option>').val(value.id).text(value.fee_type)
								.appendTo(fee_type);
		...
		<div id="logout" style="padding-left: 1163px; padding-top: 0px;">
			<ul class="nav navbar-right navbar-top-links "
				...
				<li class="dropdown" style="margin-top: -10px;"><a
					...
					style="line-height: 1px; padding: 25px;"> <!--                             <span class='icon'><img src="./images/user-icon.png" style="height: 40px;width: 60px; "> secondtruth</span>  <b class="caret"></b> -->
					...
					<li><a href="#"> <span class='icon'><img
						...
						<ul class="nav nav-second-level">
							<li><a href="student_attendence_information">Hostel
									Attendence</a></li>
							<li><a href="student_admission_list">Student Admission </a></li>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<b>Student Exam And Tution Fee Paid</b>
								<c:if test="${courseName ne ''}">
									<font color="blue"><center>Course :
											${courseName} and Branch : ${branchName} and Year :
											${academicYear} and FeeType :${feeType} and From
											Date:${fromDate} and To Date:${toDate}</center></font>
								</c:if>
							</div>
							<div class="panel-body">
								<div class="row" style="margin-right: 101px;">
									...
									<div class="col-lg-4 ">
										...
										<form action="student_examandtution_feepaid_list" method="GET">
											...
											<table id="table_width" width="1000">
												...
												<tr>
													...
													<td><select id="fee_type" name="fee_type"
														style="font-size: 14px; margin-left: 88px;">
															<option value="0">Choose Fee Type</option>

													</select></td>
													<td>From:<input type="date" id="availed_from"
														name="availed_from" style="line-height: 20px;"></td>
													<td>To:<input type="date" id="availed_to"
														name="availed_to" style="line-height: 20px;"></td>
												</tr>
												<tr>
													<td><br></td>
												</tr>
												<tr>
													<td><input type="submit" class="btn btn-primary"
														id="submitId" value="Submit Details"
														style="margin-left: 360px;"></td>
									...
									<c:if test="${not empty examAndTutionFeePaidList}">
										<table
											...
											<form>
												...
												<c:forEach items="${examAndTutionFeePaidList}" var="details">
													<tr>
														<td>${sno}</td>
														<td>${details.name}</td>
