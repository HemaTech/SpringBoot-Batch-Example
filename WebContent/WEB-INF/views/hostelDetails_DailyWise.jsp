...
$(document).ready(function(){
		 ...
		 var avialdate=$("#availed_from").val();
		 if(avialdate==""){
				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"> <span class='icon'><img
						...
						<ul class="nav nav-second-level">
							...
							<li><a href="feepaid_dailywise_list">Fee Paid DailyWise</a>
							</li>
							<li><a href="hostedetails_dailywise">Hostel Report
									DailyWise</a></li>
							...
							<div class="panel-body">
								<div class="row" style="margin-right: 101px;">
									...
									<div class="col-lg-4 ">
										...
										<form action="hostedetails_dailywise" method="GET" id="form">

											<table id="table_width" width="1000">

												<tr>
													<td>Choose Date:<input type="date" id="availed_from"
										...
										<table
											...
											<c:set var="sno" value="${1}" />
												...
												<c:forEach items="${hostelDetailsDailyWiseList}" var="details">
													<tr>
														<td>${sno}</td>
														<td>${details.name}</td>
