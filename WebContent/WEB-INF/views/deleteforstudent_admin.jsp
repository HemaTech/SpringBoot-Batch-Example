...
/* $( document ).ready(function() {
	...
	function student_delete_details(){
	...
	//alert(JSON.stringify(candidate));
		$.ajax({
			//url : "http://192.168.0.32:7771/api/student/update",
				//url : "http://host.docker.internal:7771/api/student-delete/"+id,
				url : "http://192.168.0.32:7771/api/student-delete/"+id,
			type : "DELETE",
		//	data : JSON.stringify(candidate),
			...
			success : function(d) {
				...
				console.log(d);
				confirm("Student Details deleted Sucessfully");
...
<body>
	<div class="generic-container" style="width: 98%">
		<div class="well lead">
			Delete For Student Details <span class="floatRight"><a
				...
				<table id="stud_info">
					...
					<tr>
						<td colspan="10"><button type="submit" class="btn btn-primary btn" id="enable_button" 
								style="margin-left: 70px;" onclick="student_delete_details()">DELETE
								</button></td>
					</tr>
				</table>
			</div>
